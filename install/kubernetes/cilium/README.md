...
| hubble.metrics.dynamic.config.configMapName | string | `"cilium-dyn-metrics-config"` | -- Name of configmap with configuration that may be altered to reconfigure metric handlers within a running agent. |
